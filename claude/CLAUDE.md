...
Use these instructions in Claude Code when the user asks for 4+1 architecture modeling, UML sequence diagrams, context modeling, architecture consistency review, or logic-code-deployment traceability.
