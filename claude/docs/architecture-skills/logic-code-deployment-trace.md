...
Use this guide to make architecture traceability explicit across logical, development, build, delivery, and deployment models.
...
- The trace table can answer "where is this design implemented, built, packaged, and deployed?"
