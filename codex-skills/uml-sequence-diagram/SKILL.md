...
description: "Use when creating, reviewing, or deriving UML sequence diagrams for use cases, runtime interactions, or code logic, including lifelines, messages, activations, combined fragments, and diagram gates."
---

# UML Sequence Diagram

Use this skill to model interaction behavior precisely enough to reveal hidden requirements, constraints, ordering, error handling, and runtime responsibilities.
